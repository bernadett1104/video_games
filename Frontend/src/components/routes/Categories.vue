...
export default {
    ...
    methods: {
        getCategories() {
            ...
            const url = `${this.$loginServer}/api/categories/allcategories`;
            fetch(url, {
                method: "GET",
                headers: headers,
            })
        ...
        updateCategory() {
            ...
            headers.append("Content-Type", "application/json");
            headers.append("Authorization", "Bearer " + this.$root.$data.token);
            const url = `${this.$loginServer}/api/categories/categoryupdate`;
        ...
        deleteCategory(id) {
            ...
            headers.append("Content-Type", "application/json");
            headers.append("Authorization", "Bearer " + this.$root.$data.token);
            const url = `${this.$loginServer}/api/categories/categorydelete`;
            let data = {
                id: id,
            };
            fetch(url, {
        ...
        createCategory() {
            ...
            headers.append("Content-Type", "application/json");
            headers.append("Authorization", "Bearer " + this.$root.$data.token);
            const url = `${this.$loginServer}/api/categories/newcategory`;
            let data = this.category;
            delete data.id;
            fetch(url, {
                method: "POST",
